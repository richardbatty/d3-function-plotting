Plotter.components = (function () {
  ...
  function createXAxis(x, axisNumbers) {
    return d3.svg.axis().scale(x).tickSize(0);
  }

  function createYAxis(y, axisNumbers) {
    return d3.svg.axis().scale(y).orient("left").tickSize(0);
  }
